            ...
            {bueros.length > 0 && (
              <section className="card">
                ...
                <p className="mt-2 text-[11px] text-ink3">
                  Im Export gibt es je Temporärbüro ein eigenes Excel — nur deren Leute, Person × Tag × Konto-Nr., zum Weiterschicken.{' '}
                  <Link to={exportLink} className="font-semibold text-steel">Zum Export ›</Link>
                </p>
              </section>
            )}
          </>
